...
export default function Cart() {
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      clearCart();
      toast.success("Order placed successfullyaj!");
      navigate("/");
    } catch (err) {
    ...
    return (
      <div className="max-w-7xl mx-auto px-4 py-20 text-center">
        ...
        <p className="text-gray-500 mb-6">
          Start browsing our products and add items to your cart
        </p>
      ...
      <div className="flex flex-col lg:flex-row gap-8 items-start">
        ...
        <div className="w-full lg:w-[380px] space-y-6 lg:sticky lg:top-28">
          <div className="bg-white rounded-3xl border border-gray-100 p-8 shadow-sm">
            ...
            <Link
              to="/products"
              className="block text-center mt-6 text-sm font-bold text-emerald-600 hover:text-emerald-700 transition-colors uppercase tracking-widest underline-offset-4 hover:underline"
            >
              Continue Shopping
            </Link>
          </div>
          ...
          <div className="bg-emerald-50 rounded-2xl p-4 border border-emerald-100 flex items-start gap-3">
            <div className="w-6 h-6 bg-emerald-100 rounded-lg flex items-center justify-center flex-shrink-0 text-emerald-600 font-black text-xs">
              !
            </div>
            <p className="text-xs text-emerald-800 leading-relaxed font-medium">
              Note: This is a quotation-based system. We will contact you with
              specific pricing and fulfillment details for your order.
            </p>
          </div>
        </div>
      </div>
