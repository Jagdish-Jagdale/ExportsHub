    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="mb-10">
                ...
                <p className="text-gray-500 mt-2">Explore our complete product catalog</p>
            </div>
                        ...
                        <div className="flex items-center justify-center gap-2 mt-10">
                            ...
                            {Array.from({ length: totalPages }, (_, i) => i + 1).map(p => (
                                <button
                                    key={p}
                                    onClick={() => setPage(p)}
                                    className={`w-10 h-10 text-sm font-medium rounded-lg transition-colors ${p === page ? 'bg-emerald-600 text-white' : 'hover:bg-gray-100 text-gray-700'
                                        }`}
                                >
                                    {p}
                                </button>
