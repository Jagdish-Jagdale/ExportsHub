...
const AboutUs = () => {
  ...
  const values = [
    ...
    },
    {
      ...
      title: "Innovation",
      description:
        "We continuously evolve our sourcing and shipping methods to bring you the most efficient and reliable export experience.",
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 leading-relaxed mb-8">
                ExportsHub is a leading global export house dedicated to
                sourcing and delivering the finest quality products from India’s
                rich heritage. We bridge the gap between local artisans and
                global markets with transparency, efficiency, and trust.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-gray-600">
              At ExportsHub, we don't just export products; we package
              reliability and deliver confidence.
            </p>
          </div>
          ...
          <div className="bg-emerald-900 rounded-[3rem] p-12 lg:p-20 relative overflow-hidden text-white">
            <div className="relative z-10 max-w-2xl">
              ...
              <p className="text-emerald-100 text-lg leading-relaxed mb-8">
                To empower global businesses with seamless access to
                high-quality Indian commodities and artisanal products,
                fostering sustainable growth and lasting international
                partnerships built on the bedrock of integrity.
              </p>
